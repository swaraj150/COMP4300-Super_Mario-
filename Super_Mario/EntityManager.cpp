...
std::shared_ptr<Entity> EntityManager::addEntity(eLevelEntitiesType entityType, eLevelEntities entityTag) {
...
EntityVec& EntityManager::getEntities(eLevelEntitiesType type) {
